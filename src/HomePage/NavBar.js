  ...
  window.addEventListener('scroll',ChangeBackground);
    return (
      <IconContext.Provider value={{ color: "white", size: "2rem", padding: "20px"}}>
        <div>
        <Navbar fixed="top" expand="lg" variant="dark" className={NavBar ? 'navBar active' : 'navBar'}>
  <Navbar.Brand href="#home"><img src={NavLogo} alt='' className='nav-img' />CS Hut</Navbar.Brand>
